...
import fey.hertzmusic.domain.model.LyricLine
import fey.hertzmusic.domain.model.LyricWord
import fey.hertzmusic.domain.model.Lyrics
import fey.hertzmusic.domain.model.Transliteration
import fey.hertzmusic.domain.model.Voice
...
private class TtmlAgents {
    ...
    fun voiceFor(agentId: String?): Voice {
        ...
        if (types[agentId] == "group") return Voice.GROUP
...
fun parseTtml(raw: String): Lyrics? =
    runCatching {
