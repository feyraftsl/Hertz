package fey.hertzmusic.playback
...
class PlaybackService : MediaLibraryService() {
    ...
    companion object {
        ...
        val CMD_SLEEP_SET = SessionCommand("fey.hertzmusic.command.SLEEP_SET", Bundle.EMPTY)
        val CMD_SLEEP_GET = SessionCommand("fey.hertzmusic.command.SLEEP_GET", Bundle.EMPTY)
        val CMD_AUDIO_SESSION =
            SessionCommand("fey.hertzmusic.command.AUDIO_SESSION", Bundle.EMPTY)
        val CMD_TOGGLE_SHUFFLE =
            SessionCommand("fey.hertzmusic.command.TOGGLE_SHUFFLE", Bundle.EMPTY)
        val CMD_CYCLE_REPEAT =
            SessionCommand("fey.hertzmusic.command.CYCLE_REPEAT", Bundle.EMPTY)
    }
